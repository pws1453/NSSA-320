...
New-NetIPAddress -InterfaceAlias Ethernet -IPAddress 10.0.3.2 -PrefixLength 24 -DefaultGateway 10.0.3.1
...
Set-DhcpServerv4OptionValue -ComputerName "central.winnet.local" -ScopeId 10.0.3.0 -DnsServer 127.0.0.1 -Router 10.0.3.1

Add-DhcpServerv4Scope -Name "linnet" -StartRange 10.0.4.240 -EndRange 10.0.4.245 -SubnetMask 255.255.255.0 -State Active
Set-DhcpServerv4OptionValue -ComputerName "central.winnet.local" -ScopeId 10.0.4.0 -DnsServer 10.0.4.104 -Router 10.0.4.1
